...
Este código implementa a interface gráfica da janela de adição de compromissos.

Desenvolvido por: Prof. Dr. Rodrigo Campiolo em 05-10-2016
...
public class CompromissoGUI extends javax.swing.JDialog {
    ...
    public String[] obtemDados() {
        ...
        textFieldAssunto.getText(), textFieldDescricao.getText(), textFieldNotificacao.getText(), count.toString()};
        this.limparCampos();
        return dados;
    }
